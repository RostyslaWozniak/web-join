    ...
    <section className="bg-white py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          <H2 className="mb-12">👨‍⚕️ Czy to rozwiązanie dla Twojej firmy?</H2>
              ...
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    Zacząć pozyskiwać nowych klientów 24 godziny na dobę, 7 dni
                    w tygodniu.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="flex h-[1lh] items-center">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    Zoptymalizować pracę swojej firmy i myśleć długoterminowo o
                    jej dynamicznym rozwoju.
                  </li>
                </ul>
              </CardContent>
            </Card>
