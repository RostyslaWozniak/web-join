...
export default function OfferEmail() {
  return (
    <Html>
      <Head />
      <Body className="m-0 bg-white p-0 font-sans text-[#455a63]">
        <Tailwind>
          <Container className="border-0 bg-white">
            <Section className="text-center">
              <Container className="mx-auto my-5 w-[600px] rounded-lg bg-white p-5 shadow-lg">
                <Header />
                <CTAButton />
                <ServicesSection />
...
const Header = () => {
  return (
    <>
      <Section className="flex items-center justify-center rounded-xl bg-[#e9fbfa] py-1">
        <Logo />
      </Section>
      <Section className="text-center">
