...
export function BookAppPreviewSection() {
  return (
    <section className="bg-gradient-to-br px-4 py-16">
      <div className="mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mb-8 max-w-4xl text-xl leading-relaxed text-gray-600">
            ...
            <br />
            Poznaj BookApp – nowoczesną stronę internetową z systemem rezerwacji
            online, zaprojektowaną specjalnie dla lokalnych firm takich jak
            Twoja.
          </p>
        </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Twoi klienci mogą zarezerwować wizytę o każdej porze dnia
                      i nocy
                    </p>
                  </div>
                </div>
